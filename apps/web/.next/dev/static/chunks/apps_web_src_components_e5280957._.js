...
function ExerciseSubmission(props) {
    ...
    const onSubmit = async ()=>{
        ...
        try {
            ...
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error((data && "error" in data ? data.error : null) ?? "No se pudo enviar la entrega");
                return;
            }
...
_s(ExerciseSubmission, "7P/Qcub6fOT/OeCkJ9JqUADtiig=", false, function() {
    return [
