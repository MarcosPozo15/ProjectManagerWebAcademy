...
"[project]/apps/web/src/components/learning/exercise-submission.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ExerciseSubmission(props) {
    _s();
    ...
    const required = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExerciseSubmission.useMemo[required]": ()=>props.requiredFiles.join(", ") || "(no especificado)"
    }["ExerciseSubmission.useMemo[required]"], [
        props.requiredFiles
    ]);
    const onSubmit = async ()=>{
        if (!files || files.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Adjunta al menos un archivo");
            return;
        }
        setLoading(true);
        try {
            ...
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data?.error ?? "No se pudo enviar la entrega");
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Entrega enviada");
            setComment("");
            setFiles(null);
        } finally{
            setLoading(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/apps/web/src/components/learning/exercise-submission.tsx",
                lineNumber: 48,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                onClick: onSubmit,
                disabled: loading,
                children: loading ? "Enviando..." : "Enviar entrega"
            }, void 0, false, {
                fileName: "[project]/apps/web/src/components/learning/exercise-submission.tsx",
                lineNumber: 51,
                columnNumber: 7
...
_s(ExerciseSubmission, "WqbalkVt1LyZ6x++jRgx2/+cwPU=");
_c = ExerciseSubmission;
var _c;
__turbopack_context__.k.register(_c, "ExerciseSubmission");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/src/components/learning/lesson-progress-toggle.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function LessonProgressToggle(props) {
    _s();
    const [completed, setCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(props.initialCompleted);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const toggle = async ()=>{
        setLoading(true);
        try {
            ...
            const data = await res.json().catch(()=>null);
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data?.error ?? "No se pudo actualizar el progreso");
                return;
            }
            setCompleted((v)=>!v);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(completed ? "Marcada como pendiente" : "Lección completada");
        } finally{
            setLoading(false);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        ...
        onClick: toggle,
        disabled: loading,
        children: loading ? "Guardando..." : completed ? "Completada" : "Marcar como completada"
    }, void 0, false, {
        fileName: "[project]/apps/web/src/components/learning/lesson-progress-toggle.tsx",
        lineNumber: 31,
        columnNumber: 10
    }, this);
}
_s(LessonProgressToggle, "mME6NuI7cRpzShoO4Xfy8ujQeqw=");
_c = LessonProgressToggle;
var _c;
__turbopack_context__.k.register(_c, "LessonProgressToggle");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_src_components_e5280957._.js.map