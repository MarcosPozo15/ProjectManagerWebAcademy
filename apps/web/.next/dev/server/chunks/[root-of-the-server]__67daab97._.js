...
"[project]/apps/web/src/app/api/submissions/files/[fileId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, ctx) {
    ...
    const file = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submissionFile.findUnique({
        where: {
            id: fileId
        },
        select: {
    ...
    const allowed = me.role === "ADMIN" || me.role === "PROFESSOR" && file.submission.teacherId === me.id || me.role === "USER" && file.submission.studentId === me.id;
    ...
    const absolute = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), file.path);
    const s = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["stat"])(absolute).catch(()=>null);
    if (!s) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "File missing on disk"
    }, {
        status: 404
    });
    const stream = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["createReadStream"])(absolute);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67daab97._.js.map