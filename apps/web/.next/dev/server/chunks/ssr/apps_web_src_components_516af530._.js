...
"[project]/apps/web/src/components/learning/exercise-submission.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ExerciseSubmission(props) {
    ...
    const required = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>props.requiredFiles.join(", ") || "(no especificado)", [
        props.requiredFiles
    ]);
    const onSubmit = async ()=>{
        if (!files || files.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Adjunta al menos un archivo");
            return;
        }
        setLoading(true);
        try {
            ...
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error((data && "error" in data ? data.error : null) ?? "No se pudo enviar la entrega");
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Entrega enviada");
            setComment("");
            setFiles(null);
            router.refresh();
        } finally{
...
"[project]/apps/web/src/components/learning/lesson-progress-toggle.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LessonProgressToggle(props) {
    const [completed, setCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(props.initialCompleted);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const toggle = async ()=>{
        setLoading(true);
        try {
            ...
            const data = await res.json().catch(()=>null);
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data?.error ?? "No se pudo actualizar el progreso");
                return;
            }
            setCompleted((v)=>!v);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(completed ? "Marcada como pendiente" : "Lección completada");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=apps_web_src_components_516af530._.js.map