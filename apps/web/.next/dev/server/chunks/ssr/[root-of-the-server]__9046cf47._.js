...
"[project]/apps/web/src/app/(dashboard)/progress/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function ProgressPage() {
    ...
    const [totalLessons, completedLessons, attempts, submissionsTotal, submissionsByStatus, feedbackReceived, correctionsDone] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].submission.groupBy({
            by: [
                "status"
            ],
            where: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].submissionFeedback.count({
            where: {
                submission: {
                    studentId: user.id
                }
        ...
        user.role === "PROFESSOR" ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$infrastructure$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].submissionFeedback.count({
            where: {
                teacherId: user.id
            }
        }) : Promise.resolve(0)
...
"[project]/apps/web/src/app/(dashboard)/progress/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/apps/web/src/app/(dashboard)/progress/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__9046cf47._.js.map